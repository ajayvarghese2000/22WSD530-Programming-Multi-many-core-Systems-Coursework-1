<!-- This readMe is in markdown format, It is best viewed using a markdown viewer -->

<!-- This is because there will be pictures and links embedded in the file -->

<!-- If you do not have a markdown viewer please visit the flowing github link to view properly -->
